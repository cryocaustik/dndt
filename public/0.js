...
var render = function() {
  ...
  return _c(
    ...
    [
      _c(
        "v-card",
        { staticClass: "mx-auto", attrs: { "min-width": "400px" } },
        [
          _c("v-img", {
            staticClass: "ma-2",
            attrs: { src: "img/logo-login-red.png", "max-width": "400px" }
          }),
          _vm._v(" "),
          _c("v-divider"),
          _vm._v(" "),
              ...
              _c(
                ...
                [
                  _c(
                    "v-btn",
                    {
                      attrs: { block: "", large: "", color: "red darken-4" },
                      on: { click: _vm.login }
                    },
                    [_vm._v("\n                    Login\n                ")]
                  ),
                  ...
                  _c(
                    "v-row",
                    { staticClass: "my-2", attrs: { align: "center" } },
                    [
                      _c("v-divider"),
                      _vm._v(" "),
                      _c("span", { staticClass: "mx-2 text-secondary" }, [
                        _vm._v("or")
                      ]),
                      _vm._v(" "),
                      _c("v-divider")
